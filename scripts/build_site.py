...
<body data-page="results">
  ...
  <main>
    ...
    <section class="search-panel" aria-label="Tìm và lọc bất động sản">
      <div class="filter-home" id="filterHome">
        <div class="search-wrap" id="searchWrap">
          ...
          <div class="inline-filter-actions">
            <button class="inline-filter-toggle" id="inlineFilterToggle" type="button" aria-expanded="false" aria-controls="filterDrawer">
              <svg class="inline-filter-icon" aria-hidden="true" viewBox="0 0 24 24">
                <path d="M4 7h10m4 0h2M14 4v6M4 17h2m4 0h10M10 14v6"/>
              </svg>
              <span class="inline-filter-label">Lọc theo nhu cầu</span>
              <b>0</b>
              <span class="inline-filter-chevron" aria-hidden="true">⌄</span>
            </button>
