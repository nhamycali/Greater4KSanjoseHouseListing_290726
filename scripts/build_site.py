...
def prepare_listing(source: dict) -> dict:
    item = dict(source)
...
<body data-page="results">
  ...
  <main>
    ...
    <section class="results-section" id="danh-sach">
      <div class="section-heading">
        ...
        <p class="area-note">1 ft² = 0,092903 m² · Số m² được làm tròn đến 1 chữ số thập phân.</p>
      </div>
  ...
  <footer class="site-footer">
    ...
    <p class="disclaimer">Dữ liệu được tái dựng từ trang MLS do người dùng cung cấp. Thông tin có thể thay đổi; người mua cần xác minh với môi giới và hồ sơ chính thức trước khi giao dịch.</p>
  </footer>
...
def main() -> None:
    ...
    listings = [prepare_listing(item) for item in source["listings"]]
